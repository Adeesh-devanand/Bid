...
username = tk.Label(frame1, text=" Username:", bg = "#AEB6BF")
...
balance = tk.Label(frame1, text="Balance:", bg = "#AEB6BF", font =("Courier", 11))
...
make_transaction = tk.Button(frame2, text = "Make Transaction", bg= "#D6DBDF", font =("Courier", 11))
make_transaction.place(relx = 0.1, rely = 0.05, relheight= 0.4, relwidth = 0.8)

mine_transactions = tk.Button(frame2, text = "Mine Dk Coins", bg= "#D6DBDF", font =("Courier", 11))
